...
<div class="max-w-6xl mx-auto py-10">
    <h1 class="text-2xl font-bold mb-4">Completed Anime</h1>

    <div class="mb-6 flex gap-4">
        <a href="{{ route('ongoing.anime') }}" class="text-gray-600 hover:underline">On-Going</a>
        <a href="{{ route('completed.anime') }}" class="text-blue-600 hover:underline">Completed</a>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        @empty
            <div class="col-span-4 text-center text-gray-500">
                Tidak ada anime dengan status "Completed".
            </div>
        @endforelse
    </div>
